...
const Ref = () => {
  ...
  const handleCopyLink = () => {
    ...
    let referralLink = `https://t.me/your_Bot_Name?start=${telegramUserId}`;
    ...
    <div className="text-center items-center text-white font-robot  container mx-auto">
      ...
      <div className="flex flex-row gap-3 items-center text-center  mt-4 py-3">
        ...
        <div >
          ...
          <p className="text-start">+0.001 TON for you and your friend</p>
        </div>
      </div>
      </div>
      ...
      {Idme ? (
            <p className="py-2 text-center text-[13px] break-words">{`https://t.me/your_Bot_Nameart=${Idme}`}</p>
          ) : (
